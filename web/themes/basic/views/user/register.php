...
<div class="container block_box">
    <div class="text-right" style="float: right;"><a href="/"><i class="glyphicon glyphicon-home"></i> 网站首页</a> &nbsp;&nbsp; 已有账号，<a href="<?php echo $this->createAbsoluteUrl('user/login'); ?>">请登录</a></div>
